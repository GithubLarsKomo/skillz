...
- Maschinenlesbare Evaluationsrubriken und ein Evaluations-Runner.
- Automatische Abhängigkeitsgraphen für `requires` und `outputs`.
- Release-Prozess mit Skill-Versionen und Changelog.
- Deprecation- und Migrationsprüfung.
