...
sourcePath: "skills/current-tax-context/SKILL.md"
tags:
  - skill
...
Ermittelt für ein Tax Matter den aktuellen, perioden- und jurisdiktionsbezogenen Steuerrechtskontext aus Primärquellen, Verwaltung, Rechtsprechung und gekennzeichneter Fachinterpretation; Practitioner-Quellen wie JUHN dienen nur als Discovery-/Interpretationslayer und bestätigen keine materielle Steuerposition.
...
- [[skills/tax-structure-pattern-library|tax-structure-pattern-library]]
...
`skills/current-tax-context/SKILL.md`
